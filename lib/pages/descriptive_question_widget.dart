...
class DescriptiveQuestion extends StatefulWidget {
  ...
  const DescriptiveQuestion({Key key, this.questionNumber, this.question, this.answerDetail, this.marks}) : super(key: key);
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: Text(widget.marks.toString()+' Marks',style: TextStyle(fontSize: 12.1,color: Colors.black26)),
                            )
                          ],
                        ),
                        SizedBox(
