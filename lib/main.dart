...
import 'package:edapt/pages/career_cart/career_cart_screen.dart';
...
void main() {
  SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
    systemNavigationBarColor: Color(0xFF2C6DFD),
    statusBarColor: Color(0xFF2C6DFD),
  ));
  runApp(MyApp());
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        '/homepage': (BuildContext context) => Dash(),
